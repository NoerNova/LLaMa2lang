...
def main():
    parser = argparse.ArgumentParser(
        description="Script to run inference on a tuned model."
    )
    parser.add_argument(
        "model_name",
        type=str,
    ...
    parser.add_argument(
        "--thread_template",
        type=str,
        default="threads/template_llama2.txt",
        help="A file containing the thread template to use. Default is threads/template_default.txt",
    )
    parser.add_argument(
        "--padding",
        type=str,
